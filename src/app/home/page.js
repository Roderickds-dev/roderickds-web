...
const Index = () => {
  return (
    <div className="relative flex flex-col min-w-max min-h-screen dark:[background:linear-gradient(315deg,_#abf7f9,_#1F2D40)] [background:linear-gradient(315deg,_#ffffff,_#ABF7F9)]">
